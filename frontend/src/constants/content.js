export const BRAND = {
  ...
  tagline: "RELAX • REJUVENATE • HEAL - WITH RAJ",
  phone: "+91 9702424106",
  phoneHref: "tel:+919702424106",
  ...
  couplesNote:
    "For couple bookings, feel free to reach out for flexible timing arrangements.",
  rating: 4.9,
  reviewCount: 124,
  logoUrl:
...
export const HERO_TAGLINE_LINES = [
  "Personalized Massage Therapy by Raj",
  "Professional Care • Personal Touch",
  "Men & Women • Couple Friendly",
  "Home • Hotel • Massage Centre",
];

export const HERO_LOCATION_LINE = "Andheri West & East, Mumbai | Close to Mumbai Airport";
...
export const SERVICE_AREAS = {
  ...
  southMumbai: ["Colaba", "Cuffe Parade", "Fort", "Marine Drive", "Lower Parel", "Worli"],
};

export const TESTIMONIALS = [
  {
    name: "Amit S.",
    text: "Extremely professional and hygienic service. Raj's deep tissue massage completely relieved my back pain. Highly recommended!",
  },
  {
    name: "Priya & Nikhil",
    text: "Booked the couple massage for our anniversary at home. Punctual, respectful, and truly relaxing experience for both of us.",
  },
  {
    name: "Farhan K.",
